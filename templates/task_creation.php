    ...
    <main>
        ...
        <section class="l-section">
            <form action="controller.php">
                ...
                <input type="date" id=tsk_deadline name="tsk_deadline">
<!--                </select>-->
                ...
                <p>
                    ...
                    <label for="tsk_description">Describe your task :</label>
                    <br>
                    <input id="tsk_description" type="textarea" name="tsk_description">
