                ...
                for ($i = 1; $i <= 100; $i++) {
                    ...
                    if ($grp_id = valider("grp_id")) {
                        if ($tsk_description = valider("tsk_description")) {
                            ...
                            new_task(htmlspecialchars($tsk_title), htmlspecialchars($tsk_description), $tsk_deadline, $grp_id, $id_usr_tab);
                        }
                    }
        ...
        case "edit_task":
            ...
            if(($tsk_id=valider('tsk_id'))&&($grp_id = valider("grp_id"))&&($tsk_description = valider("tsk_description"))) {
                ...
                if ($tsk_deadline = valider("tsk_deadline")) {
                    //tout est vérifié, on peut appeler la fonction de création dans modele.
                    edit_task($tsk_id, htmlspecialchars($tsk_description), $tsk_deadline, $grp_id, $id_usr_tab);
                    edit_task((int)$tsk_id,htmlspecialchars($tsk_description), $tsk_deadline, $grp_id, $id_usr_tab);
                }
				else{
